    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "complex_labor_rate",
                    models.DecimalField(decimal_places=2, default=200.0, max_digits=6),
                ),
                (
                    "environmental_fee",
                ...
                (
                    "markup_multiplier",
                    models.DecimalField(decimal_places=2, default=1.3, max_digits=4),
                ),
                ("mobile_fee_tier_1_distance", models.PositiveIntegerField(default=15)),
                (
                    "mobile_fee_tier_1_amount",
        ...
        migrations.CreateModel(
            ...
            options={
                "ordering": ["-priority"],
                "unique_together": {
                    ("shop", "manufacturer", "glass_type", "pricing_strategy")
                },
            },
        ),
    ]
