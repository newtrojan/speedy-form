...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_type",
                    models.CharField(
                        choices=[("cash", "Cash/Credit"), ("insurance", "Insurance")],
                        max_length=20,
                    ),
                ),
                (
                ...
                (
                    "source",
                    models.CharField(
                        choices=[("website", "Website"), ("vapi", "VAPI Call")],
                        default="website",
                        max_length=20,
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="quote",
            index=models.Index(
                fields=["state", "created_at"], name="quotes_quot_state_794863_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="quote",
            index=models.Index(
                fields=["postal_code", "service_type"],
                name="quotes_quot_postal__09814a_idx",
            ),
        ),
    ]
