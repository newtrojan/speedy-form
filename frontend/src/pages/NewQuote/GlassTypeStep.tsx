...
import type { GlassType, DamageType, DamageQuantity } from '@/types/api';

// Glass type options with icons
...
export function GlassTypeStep() {
  ...
  >(formData.damageType);
  const [selectedDamageQuantity, setSelectedDamageQuantity] = useState<
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Save all selections to form context
    updateFormData({
    ...
    <Card className="p-8">
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-8">
          ...
          {/* Damage Assessment Section - Shows when glass type is selected */}
          {selectedGlass && (
            <div className="space-y-6 p-6 bg-gray-50 border-l-4 border-[#DC2626] rounded">
          ...
          <div className="flex gap-4 pt-4">
            ...
            <Button
              ...
              disabled={!selectedGlass || !selectedDamageType || !selectedDamageQuantity}
            >
              Continue
            </Button>
          </div>
